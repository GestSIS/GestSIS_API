...
class InterventionMissionTest extends TestCase
{
    ...
    {
        $missions = factory('App\Models\Mission', 3)->make(['intervention_id' => $this->interventionId]);
    ...
    {
        $missions = factory('App\Models\Mission', 3)->make(['intervention_id' => $this->interventionId])->toArray();
