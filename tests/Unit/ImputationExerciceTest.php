...
class ImputationExerciceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $exerciceService = $this->app->make('App\Services\ExerciceService');
        $sapeurService = $this->app->make('App\Services\SapeurService');
        $this->comptabiliteService = $this->app->make('App\Services\ComptabiliteService');
