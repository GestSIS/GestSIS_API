...
class ControleController extends Controller
{
    ...
    public function articlesAControler(): JsonResponse
    {
        return response()->json(['data' => ControleBusiness::getArticlesAControler()]);
    }

    public function articlesLimiteExecutions(): JsonResponse
    {
        return response()->json(['data' => ControleBusiness::getArticlesLimiteExecutions()]);
    }
    ...
    public function store(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'recurrence_type'        => 'required|string|in:PERIODIQUE,NON_PERIODIQUE',
            ...
            'nb_execution_max'       => 'nullable|integer|min:1',
            'nb_execution_preavis'   => 'nullable|integer|min:1',
