  ...
  public function collection()
  {
    ...
    $data = $query->leftJoin('civilites', 'civilites.id', '=', 'sapeurs.civilite_id')
      ...
      ->select([
        ...
        'grades.designation as grade_nom',
        'grades.abreviation as grade_abr',
        'fonctions.nom as fonction_nom',
        'fonctions.abreviation as fonction_abr',
        'sapeur_telephone.numero as tel_numero',
        'sapeur_telephone.telephone_type_id as tel_type',
        'sapeur_telephone.priorite as tel_priorite',
      ])
