...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('maintenance_types', function (Blueprint $table) {
            ...
            $table->string('designation');
            $table->int('periodicite'); // Si à zéro alors peut-être fair sur un ou plusieurs matériels
            $table->boolean('externalise');
        });

        Schema::create('maintenance_type_materiel_types', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->timestamps();
            ...
            $table->unique(['maintenance_type_id', 'materiel_type_id']);
        });
