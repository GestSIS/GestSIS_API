...
class IndemniteInterventionTypeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $indemnites = array(
            ...
            array('designation' => 'Intervention', 'type' => ImputationBusiness::ECRITURE_CATEGORIE_IMPOSITION_SOLDE, 'ecriture_categorie_id' => 4, 'compte_id' => 4, 'tarif' => 30.0, 'type_unite_id' => 2, 'tarif_min' => null, 'tarif_min_pour' => null, 'tarif_min_pro_rata' => false, 'tarif_pro_rata' => false, 'phase_id' => null, 'par_fonction' => false, 'taux_weekend' => 1.25, 'taux_nuit' => 1.25, 'debut' => '20:00', 'fin' => '08:00'),
        );
